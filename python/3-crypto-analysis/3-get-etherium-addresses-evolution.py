...
ax[0].vlines(CHSB_introduction, ymin = 0, ymax = max(df_addresses["addr_count"]),color="red",label="CHSB introduction")
ax[0].legend(['Number of addresses','CHSB introduction'])
